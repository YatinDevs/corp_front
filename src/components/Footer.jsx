  ...
  return (
    <>
      <motion.footer
        ...
        className="bg-gradient-to-r from-[#1b53a5] to-[#a30d14] text-[#d4d3d0] -mb-14 pt-16 pb-20 px-6 md:px-16"
      >
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="flex gap-4 mt-6">
              {socialIcons.map(({ icon: Icon, label, color }, index) => (
                <motion.a
                  ...
                  title={label}
                  className={`cursor-pointer bg-[#1b53a5] p-3 rounded-full hover:bg-[#fcce01] hover:text-[#1b53a5] ${color}`}
                >
                  <Icon size={16} />
                </motion.a>
              ))}
          ...
          >
            <h3 className="text-lg font-semibold mb-4 flex items-center text-[#fcce01]">
            ...
            <ul className="space-y-2">
              {productCategories.map((link, index) => (
                ...
                >
                  <a
                    href={link.link}
                    className="text-[#d4d3d0]/80 hover:text-[#fcce01] transition-colors flex items-center text-sm"
                  >
                    {link.name}
                  </a>
                </motion.li>
            ...
            <ul className="space-y-2">
              {quickLinks.map((link, index) => (
                ...
                >
                  <a
                    href={link.link}
                    className="text-[#d4d3d0]/80 hover:text-[#fcce01] transition-colors text-sm"
                  >
                    {link.name}
                  </a>
                </motion.li>
          ...
          >
            <h3 className="text-lg font-semibold mb-4 text-[#fcce01]">
              Contact Us
            </h3>
            <ul className="text-[#d4d3d0]/80 space-y-3 text-sm">
              <li className="flex items-start gap-3">
                <IoLocationOutline size={18} className="mt-1 text-[#fcce01]" />
                <span>
              ...
              <li className="flex items-center gap-3">
                <IoCallOutline size={18} className="text-[#fcce01]" />
                <a href="tel:+917030875102" className="hover:text-[#fcce01]">
                  +91 70308 75102
                </a>
              </li>
              <li className="flex items-center gap-3">
                <MdOutlineEmail size={18} className="text-[#fcce01]" />
                <a
                  href="mailto:smitaaaher@corpgiftgpt.com"
                  className="hover:text-[#fcce01]"
                >
        ...
        {/* Footer Bottom - Add copyright section if needed */}
        <div className="max-w-7xl mx-auto mt-16 pt-6 border-t border-[#d4d3d0]/20">
          <p className="text-center text-[#d4d3d0]/60 text-sm">
            © {new Date().getFullYear()} CORP GIFT GPT. All rights reserved.
          </p>
        </div>
      </motion.footer>
